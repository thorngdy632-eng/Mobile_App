...
class NotificationsScreen extends StatelessWidget {
  ...
  static const List<_Notification> _items = [
    _Notification(
      ...
      body: 'ការងារ គោយន្តដឹកស្រូវ នៅ ស្រុកបាទី ត្រូវបានបញ្ជាក់',
      time: '10 នាទីមុន',
    ),
    _Notification(
      ...
      title: 'ការដឹកថ្មី',
      body: 'មានការដឹកថ្មី: ជីពី ក្រុងសិរីស្វាយប៉ាវ ទៅ ស្រុកបាទី (\$80)',
      time: '30 នាទីមុន',
    ),
    _Notification(
      ...
      title: 'ការរំលឹក',
      body: 'ការងាររបស់អ្នកស្អែក ព្រឹក ៦:៣០ — ឡានដឹកកូនឈើ',
      time: '១ ម៉ោងមុន',
    ),
  ];
